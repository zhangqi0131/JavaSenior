package com.zq.project_2.util;

/**
 * @program: JavaSenior
 * @description:
 * @author: Zhang.Qi
 * @create: 2021-04-27 16:50
 **/

import java.util.Scanner;

/**
 * 工具类：将不同的功能封装为方法，就是可以直接通过调用方法使用它的功能，
 *        而无需考虑具体的功能实现细节
 */
public class CMUtility {
    ...
    /**
     * 从键盘读取一个字符，并将其作为方法的返回值
     * 如果用户不输入字符而直接回车，方法将以defalutValue作为返回值
     */
    ...
    /**
     * 用于用户确认选择的输入，该方法从键盘读取'Y'或'N'，并将其作为方法的返回值
     */
